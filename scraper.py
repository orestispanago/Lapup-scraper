...
def send_mail(observation):
    ...
    fromaddr = "username.raspberry@gmail.com" # mail account created for the pi
    recipients = ['recipient1@upatras.gr','recipient2@upatras.gr']
    ...
    server.starttls()
    server.login(fromaddr, "password") # password for the pi mail account
    text = msg.as_string()
